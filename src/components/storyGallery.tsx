...
const WavyUnderline = ({ isInView }: { isInView: boolean }) => (
  <svg 
    ...
    className="mt-1 w-[170px] sm:w-[190px] md:w-[230px] h-auto"
  >
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="relative inline-block mt-2">
            <motion.h2 className="text-4xl sm:text-[40px] md:text-5xl font-bold text-gray-900 font-gtpro tracking-wide">
