      ...
      <DialogTrigger asChild>
        ...
        >
          ...
          <div className="relative bg-gradient-to-l from-green-500 to-green-600 rounded-l-2xl shadow-lg pl-3 sm:pl-4 pr-2 py-3">
            ...
            {/* Notification dot */}
            {/* <motion.div 
              className="absolute -top-1 -left-1 size-2 sm:size-3 bg-red-500 rounded-full border-2 border-white shadow-lg"
              animate={{ scale: [1, 1.2, 1] }}
              transition={{ duration: 1.5, repeat: Infinity }}
            /> */}
          </div>
          
          {/* Tooltip - positioned to the left since we're on the right edge */}
          <motion.div 
