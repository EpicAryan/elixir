...
//     onFinalStepCompleted?: (data: FormData) =>  Promise<{ priceRange: string }>; 
//     formData: FormData;
...
//     initialStep = 1,
//     onStepChange = () => {},
//     onFinalStepCompleted = () =>  Promise.resolve({ priceRange: "" }),
//     formData,
//     setFormData
// }: StepperProps) {
...
//                 setCalculatedPrice(result.priceRange);
//                 setIsCompleted(true);
//             } catch (error) {
        ...
        if (!isNextDisabled(currentStep, formData)) {
            ...
            try {
                ...
                const queryParams = new URLSearchParams({
                    ...
                    size: formData.bhkSizes?.[formData.bhkType] || 'small',
                    ...
                    location: formData.contactInfo.propertyName
                });
                
                router.push(`/quote-summary?${queryParams.toString()}`);
            } catch (error) {
                console.error('Submission error:', error);
                setIsSubmitting(false); 
            }
